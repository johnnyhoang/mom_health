  ...
  return (
    <article className="w-full bg-slate-950 text-slate-200 font-sans pb-32">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <button 
                ...
                className="px-3 py-1.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-300 border border-rose-500/30 text-xs font-semibold transition-all flex items-center gap-1.5 cursor-pointer"
              >
      ...
      <section id="ankle-ch-1" className="w-full max-w-5xl sm:max-w-6xl mx-auto py-6 px-4 sm:px-6 space-y-5 border-t border-slate-800/80">
        ...
        <div className="p-3.5 sm:p-4 bg-gradient-to-r from-rose-950/30 to-slate-900 border border-rose-500/40 rounded-2xl space-y-2">
      ...
      <section id="ankle-ch-2" className="w-full max-w-5xl sm:max-w-6xl mx-auto py-6 px-4 sm:px-6 space-y-5 border-t border-slate-800/80">
        ...
        <div className="p-4 sm:p-5 bg-slate-900/60 border border-slate-800 rounded-2xl space-y-4">
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 text-xs text-slate-300 leading-relaxed">
              <div className="p-3 bg-slate-950/70 rounded-xl border border-slate-800/80">
                <strong className="text-emerald-400 block mb-1">Weber A (Dưới khớp): </strong>Gãy mỏm xương mác dưới mức khe khớp, khớp chày mác nguyên vẹn, thường điều trị bó bột bảo tồn.
              </div>
              <div className="p-3 bg-slate-950/70 rounded-xl border border-rose-500/30">
                <strong className="text-rose-400 block mb-1">Weber B (Ngang khớp - Ca của Cụ): </strong>Đường gãy chéo xoắn ngang mức khe khớp sên cẳng chân, tổn thương 50% khớp chày mác $\rightarrow$ Cần nẹp vít.
              </div>
              <div className="p-3 bg-slate-950/70 rounded-xl border border-slate-800/80">
                <strong className="text-amber-400 block mb-1">Weber C (Trên khớp): </strong>Gãy thân xương mác cao, toác toàn bộ màng gian cốt chày mác $\rightarrow$ Phẫu thuật nẹp vít kết hợp siết khớp.
              </div>
            </div>
          </div>
          ...
          <div className="pt-3 border-t border-slate-800/80 space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 text-xs text-slate-300 leading-relaxed">
              <div className="p-2.5 rounded-lg bg-slate-950/50 border border-slate-800"><strong className="text-rose-300 block mb-0.5">• Dây chằng ATFL: </strong>Giữ bờ ngoài, khi đứt làm lỏng khớp. Khâu phục hồi/dùng chỉ sinh học.</div>
              <div className="p-2.5 rounded-lg bg-slate-950/50 border border-slate-800"><strong className="text-amber-300 block mb-0.5">• Dây chằng CFL: </strong>Giữ vững gót chân khi nghiêng trong. Rách bán phần tự lành với CAM boot.</div>
              <div className="p-2.5 rounded-lg bg-slate-950/50 border border-slate-800"><strong className="text-cyan-300 block mb-0.5">• Khớp chày - mác: </strong>Giữ 2 xương khép sát. Khi toác cần siết dây neo TightRope/vít định vị.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="ankle-ch-3" className="w-full max-w-5xl sm:max-w-6xl mx-auto py-6 px-4 sm:px-6 space-y-5 border-t border-slate-800/80">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 sm:p-5 space-y-4">
          ...
          {/* Layman Analogy */}
          <div className="p-3 bg-rose-950/20 border border-rose-800/30 rounded-xl space-y-1">
          ...
          {ankleFractureMediaItems.map((item) => (
            ...
            >
              ...
              >
                ...
                <div className="absolute top-2 left-2 px-1.5 py-0.5 rounded bg-rose-500/80 text-white text-[9px] font-bold uppercase tracking-wider">
                  {item.category}
                </div>
              </div>
              ...
              <div className="space-y-2 pt-1">
                {currentDecisionNode.options.map((option, idx) => (
                  <button
                    ...
                    className="w-full text-left p-3.5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-rose-500/50 hover:bg-slate-900/90 transition-all space-y-0.5 group cursor-pointer"
                  >
                    <div className="text-xs sm:text-sm font-bold text-white group-hover:text-rose-300 transition-colors flex items-center justify-between">
      ...
      <section id="ankle-ch-7" className="w-full max-w-5xl sm:max-w-6xl mx-auto py-6 px-4 sm:px-6 space-y-5 border-t border-slate-800/80">
        ...
        <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
          <button
            ...
            className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 hover:border-rose-500/50 hover:bg-slate-850 transition-all text-left space-y-1 group cursor-pointer"
          >
          ...
          <button
            onClick={onNavigateToDoctors}
            className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 hover:border-cyan-500/50 hover:bg-slate-850 transition-all text-left space-y-1 group cursor-pointer"
          >
